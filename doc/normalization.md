...
```
Shift-JISのダメ文字問題については、<a href="#コラムshift-jisのダメ文字問題">コラム：Shift-JISのダメ文字問題</a>、マルチバイト文字のマッチングエラーについては<a href="">コラム：マルチバイト文字のマッチングエラー</a>をご参照ください。それから、
***
